    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                items: [
                    { label: 'Decisions Log', icon: 'pi pi-fw pi-file-edit', routerLink: ['/decisions'] },
                    { label: 'Tasks Dashboard', icon: 'pi pi-fw pi-check-square', routerLink: ['/tasks'] }
                ]
            },
            {
                label: 'Reports',
                items: [
                    { label: 'Meeting Summaries', icon: 'pi pi-fw pi-book', routerLink: ['/reports/summaries'] },
